...
<html lang="pt-br">
  <head>
    ...
    @section('assetsCss')
        ...
        {!! Html::style('css/plugins/fullcalendar.min.css') !!}
 ...
 <body id="mimin" class="dashboard">
      <!-- start: Header nav-top -->
        
        @include('dashboard.parts.nav-top')
      ...
      <!-- start: Mobile -->
        @include('dashboard.parts.mobile')
      <!-- end: Mobile -->
    ...
    @section('assetsJs')
      ...
      <!-- plugins -->
       ...
       {!! Html::script('js/plugins/jquery.nicescroll.js') !!}
       {!! Html::script('js/plugins/jquery.vmap.min.js') !!}
       {!! Html::script('js/plugins/maps/jquery.vmap.world.js') !!}
       {!! Html::script('js/plugins/jquery.vmap.sampledata.js') !!}
